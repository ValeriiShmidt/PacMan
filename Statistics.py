...
class Statistics:
    ...
    def simulate_state(self, direction, mob_type):
        ...
        if mob_type == PLAYER:
            ...
            return Statistics(self.grid_map, self.coins_positions, player_position, self.enemies_positions, self.walls)
            ...
            for i, ghost in enumerate(enemies_positions):
                ...
                return Statistics(self.grid_map, self.coins_positions, self.player_position, enemies_positions,
                                  self.walls)
